...
<pre data-sider-select-id="49412d48-f903-435e-950f-68036324439e"><strong>Input:</strong> nums = [1,2,3,1,1,3]
...
<pre data-sider-select-id="3c094a62-e5b9-45e9-849f-fb77ab41397f"><strong>Input:</strong> nums = [1,1,1,1]
